...
import {  Section, SectionFormData, SectionStatus, Tone } from '@/@types/types'
import SectionFormFields from '@/components/dashboard/sections/sectionFormField'
...
const handleSaveSection = async()=>{
    ...
    if(selectedSources.length === 0){
        alert("Please select at least one knowledge source"); // you can use toastify
        return;
    }
    ...
    try {
        ...
        if(!response.ok){
            throw new Error("Failed to create sdection") // could add here toast
        }
             ...
             {selectedSection && (
                ...
                {selectedSection.id !== "new"  && (
                    <div className='p-6 bg-red-500/5 border-t border-red-500/10'>
                        ...
                        variant="destructive"
                        size="sm"
                        className='w-full bg-red-500/10 text-red-500 border border-'
