...
const GoldPkg: React.FC = () => {
  ...
  return (
    <Card className="shadow-md w-full overflow-hidden border-2 border-yellow-200">
      {/* Package Header */}
      <CardHeader className="bg-gradient-to-r from-yellow-600 to-yellow-700 text-white p-6 space-y-2">
      ...
      <CardContent className="p-6 space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            {items.map((item) => (
              <div
                key={item.id}
                className="grid grid-cols-12 gap-2 items-center bg-gradient-to-r from-yellow-50 to-yellow-100 p-3 rounded-lg border border-yellow-200"
              >
        ...
        <div className="space-y-4">
          <button
            ...
            className="flex items-center justify-between w-full p-3 bg-gradient-to-r from-yellow-50 to-yellow-100 rounded-lg hover:from-yellow-100 hover:to-yellow-200 transition-all border border-yellow-200"
          >
            <div className="flex items-center gap-2">
          ...
          {isBenefitsVisible && (
            <div className="space-y-3 pl-8">
              {benefits.map((benefit) => (
                <div
                  key={benefit.id}
                  className="bg-gradient-to-r from-yellow-500 to-yellow-600 text-white p-4 rounded-lg shadow-sm"
                >
        ...
        {/* Price Display */}
        <div className="bg-gradient-to-r from-yellow-100 to-yellow-200 p-6 rounded-lg text-center border border-yellow-300">
