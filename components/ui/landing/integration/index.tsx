            ...
            <div className='flex-1 w-full max-w-lg'>
                <div className='glass-card rounded-xl p-6 relative'>
                    <div className='flex items-center justify-between mb-4'>
                        ...
                        <div className='w-3 h-3 rounded-full bg-red-500/20 border border-yellow-500/50'></div>
                        <div className='w-3 h-3 rounded-full bg-red-500/20 border border-green-500/50'></div>
                    ...
                    <div className='pl-4' >
                        ...
                        <span className='text-emerald-400'>
                            &quot;b7885803-18ca-47b-baf6-c6b289e309a5&quot;
                        </span>
                        <br />
