    ...
    <section id="features"  className='py-32 px-6 max-w-6xl mx-auto'>
        <div className='mb-20'>
            ...
            <p className='text-xl text-zinc-500 font-light max-w-xl leading-relaxed'>
                Most AI support tools hallucinate. Ours is strictly grounded in your content, 
                with a personality you control.
            </p>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
            ...
            <p className='text-sm text-zinc-400 font-light leading-relaxed'>
                We crawl your site and docs to build a structured understanding of your product. 
            ...
            <p className='text-sm text-zinc-400 font-light leading-relaxed'>
               Whether you&apos;re professional, quirky, or concise, the AI mimics yourbrand voice perfectly.
