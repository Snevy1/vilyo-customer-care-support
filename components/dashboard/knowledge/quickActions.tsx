    ...
    <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
      ...
      >
        ...
        <div className='space-y-1.5 text-center w-full'>
          ...
          <p className='text-xs text-zinc-500 font-normal leading-relaxed whitespace-normal wrap-break-word '>
             Uplaod CSV files to instantly train your assistant with existing
             documents 
          </p>
      ...
      >
        ...
        <div className='space-y-1.5 text-center w-full'>
          ...
          <p className='text-xs text-zinc-500 font-normal leading-relaxed whitespace-normal wrap-break-word '>
             Manually copy-paste FAQs, internal notes, or policies directly into the editor for quick uploads
          </p>
