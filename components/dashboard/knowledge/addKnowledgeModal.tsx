      ...
      <DialogContent className='sm:max-w-150 bg-[#0E0E12] border-white/10 text-zinc-100 p-0 overflow-hidden gap-0 '>
          ...
          >
            ...
            <TabsList className='bg-transparent h-auto p-0 gap-6'>
              <TabsTrigger
              value='website'
              className='data-[state=active]:bg-transparent data-[state=active]:shadow-none data-[state=active]:border-b-2 data-[state=active]:border-indigo-500 rounded-none px-0 py-3 text-xs uppercase tracking-wider text-zinc-500 data-[state=active]:text-white transition-all focus-visible:ring-offset-0 focus-visible:outline-none  focus:outline-none ring-0 outline-none border-t-0 border-x-0 '
            ...
            <div className='p-6 min-h-50 space-y-4'>
              {
                error && (
                  ...
                  >
                    ...
                    <AlertDescription className="ml-2 textxs">
                      {error}
                    </AlertDescription>
              ...
              >
                ...
                <div
  className='border-2 border-dashed border-white/10 rounded-xl p-8 text-center cursor-pointer hover:bg-white/5 transition-colors flex flex-col items-center justify-center gap-2'
