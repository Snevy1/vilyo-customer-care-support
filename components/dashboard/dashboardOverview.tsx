...
const setupSteps = [
    ...
    {label:"Knowledge Added", complete: counts.knowledge > 0,
  ...
  return (
    <div className='p-6 md:p-8 space-y8 max-w-7xl mx-auto animate-in fade-in duration-500'>
              ...
              {setupSteps.map((step,i)=>(
                <Link key={i} href={step.href} className='block group'>
                    ...
                    className={cn(
                        ...
                        step.complete 
                        ? "opacity-60":"border-indigo-500/30 bg-indigo-500/5 hover:bg-indigo-500/10"
        ...
        <div className='grid grid-cols-2 lg:grid-cols-3 gap-8'>
            <div className='lg:col-span-2 space-y-8'>
                ...
                <CardHeader className='flex flex-row items-center justify-between pb-2'>
                    ...
                    <Button
                    size="sm"
                    className='h-8 gap-1 bg-white text-black hover:bg-zinc-600'
                    asChild
                    >
                ...
                <CardContent className='p-0'>
                    ...
                    {sections.list.length === 0 ? (
                        <div className='p-6 text-center text-sm text-zinc-500'>No sections configured yet</div>
                    ): (
                        <>
            ...
            <div className='space-y-8'>
                ...
                <CardHeader>
                    ...
                    <CardDescription>
                        Add this snippet to your website appropriate page e.g on page &apos;s &lt;head&gt; tag.
                    </CardDescription>

                </CardHeader>
                <CardContent>
                    <div className='relative group'>
                        <pre className='bg-[#050509] p-4 rounded-lg text-xs text-zinc-50'>
