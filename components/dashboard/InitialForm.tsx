            ...
            <div className='flex flex-col items-center justify-center text-center animate-in fade-in duration-700'>
               ...
               <div className='relative mb-8'>
                <div className='absolute inset-0 bg-indigo-500/20 blur-xl rounded-full animate-pulse ' />
                 <div className='relative w-16 h-16 bg-linear-to-tr from-indigo-500 to-purple-500 rounded-2xl flex items-center justify-center sadow-lg shadow-indigo-500/20'>
            ...
            >
             ...
             <div className='space-y-6'>
                ...
                <div className='relative group'>
                    {
                        stepData.type === "textarea"  ? (
                            ...
                            onKeyDown={handleKeyDown}
                            placeholder={stepData.placeholder}
                            className='w-full bg-transparent border-0 border-b border-white/10 text-xl md:text-2xl py-4 pr-12 text-white placeholder:text-zinc-700 focus-visible:ring-0 focus-visible:border-indigo-500 rounded-none h-auto min-h-30 shadow-none transition-colors'
                            autoFocus
                            />
                        )
                    }
                ...
                <div className='flex items-center justify-between pt-8'>
                    ...
                    className={cn(
                        "rounded-full px-8 py-6 text-bae font-medium transition-all duration-300",
                        !isStepValid ? "bg-zinc-800 text-zinc-500 hover:bg-zinc-800 cursor-not-allowed"
